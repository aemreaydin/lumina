...
protected:
  ...
  {
    Logger::Info("TextureApp::OnInit - Creating resources");
    ...
    Logger::Info("TextureApp::OnInit - Resources created");
  }
  ...
  {
    Logger::Info("TextureApp::OnDestroy - Cleaning up resources");
...
{
  return std::make_unique<TextureApp>();
}
