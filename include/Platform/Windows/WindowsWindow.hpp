#ifndef PLATFORM_WINDOWSWINDOW_HPP
#define PLATFORM_WINDOWSWINDOW_HPP
...
public:
  ...
  auto operator=(const WindowsWindow&) -> WindowsWindow& = delete;
  auto operator=(WindowsWindow&&) -> WindowsWindow& = delete;
